...
class ModelConfig:
    ...
    """
    Whether to return key/value cache for faster inference during generation.
    """
...
class LLaDAConfig(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        # use_cache is explicitly removed from the config in later transformer versions,
        # but LLADA impl. depends on it being present in the model at forward pass time
